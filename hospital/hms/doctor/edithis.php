...
$msg="Se actualizaron los datos medicos";
...
<html lang="en">
	<head>
		<title>Admin | Editar historial medico</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">ADMINISTRADOR | EDITAR DETALLES </h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Editar información medica</h5>
												</div>
												<div class="panel-body">
									<?php $sql=mysqli_query($con,"select * from tblmedicalhistory where ID='$did'");
...
<div class="form-group">
		...
		<input type="text" name="Weight" class="form-control" required="required"  value="<?php echo htmlentities($data['Weight']);?>" >
														</div>
...
<div class="form-group">
					...
					<input type="text" name="Temperature" class="form-control" required="required"  value="<?php echo htmlentities($data['Temperature']);?>">
														</div>
...
<div class="form-group">
					...
					<input type="text" name="MedicalPres" class="form-control"   value="<?php echo htmlentities($data['MedicalPres']);?>">
														</div>	
														<div class="form-group">
									<label for="fess">
																Medico
