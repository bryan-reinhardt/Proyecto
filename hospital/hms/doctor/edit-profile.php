...
<html lang="en">
	<head>
		<title>Doctor | Editar Detalles del Doctor</title>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Editar Detalles del Doctor</h5>
												</div>
...
<p><b>Fecha de creación: </b><?php echo htmlentities($data['creationDate']);?></p>
<?php if($data['updationDate']){?>
<p><b>Fecha de Actualizacion del perfil: </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
<hr />
