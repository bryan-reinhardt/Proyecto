...
<html lang="en">
	<head>
		<title>PACIENTE | AÑADIR PACIENTE</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">PACIENTE | EDITAR PACIENTE</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Patient</span>
...
<img width="300" height="200" src="ico/8.jpg">
</div>
...
<div class="form-group">
              ...
              <?php } else { ?>
              <label>
              <input type="radio" name="gender" id="gender" value="Male" checked="true">Hembra
              <input type="radio" name="gender" id="gender" value="Female">Masculino
              </label>
             <?php } ?>
            </div>
<div class="form-group">
