...
{
$ret=mysqli_query($con,"SELECT * FROM admin WHERE cedula='".$_POST['cedula']."' and password='".md5($_POST['password'])."'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
$extra="dashboard.php";//
$_SESSION['login']=$_POST['cedula'];
$_SESSION['id']=$num['id'];
				...
				Iniciar sesión en su cuenta
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="text" class="form-control" name="cedula" placeholder="cedula registrada">
