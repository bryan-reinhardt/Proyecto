...
if($query){
echo "<script>alert('Comentario de administrador actualizado con éxito.');</script>";
...
<html lang="en">
	<head>
		<title>Admin | Detalles de Consultas</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								...
								<ol class="breadcrumb">
									...
									<li class="active">
										<span>Detalles de Consultas</span>
									</li>
								</ol>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Administrar <span class="text-bold">Detalles de Consultas</span></h5>
...
<form name="query" method="post">
	<tr>
												<th>Observacion del Administrador</th>
