...
{
$sql=mysqli_query($con,"SELECT password FROM  admin where password='".md5($_POST['cpass'])."' && username='".$_SESSION['login']."'");
...
<html lang="en">
	<head>
		<title>Ejecutivo | Cambiar Contraseña</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Ejecutivo| CAMBIAR LA CONTRASEÑA</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>EJECUTIVO </span>
