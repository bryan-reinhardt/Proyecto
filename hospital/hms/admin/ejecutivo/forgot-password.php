...
$query=mysqli_query($con,"select id from  admin where eje='$eje' and username='$username'");
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="user-login.php"><h2> HW | Recuperación de contraseña ejecutiva</h2></a>
				</div>
						...
						<fieldset>
							...
							<div class="form-group form-actions">
								<span class="input-icon">
									<input type="text" class="form-control" name="eje" placeholder="indentificador">
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="text" class="form-control" name="username" placeholder="nombre del Ejecutivo">
