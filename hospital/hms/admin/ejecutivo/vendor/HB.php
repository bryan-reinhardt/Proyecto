				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Adminnistracion | ESPECIALIZACIÓN MÉDICA</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
									...
									<li class="active">
										<span>Doctor Especialización</span>
									</li>
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Doctor Especialización" required="">
														</div>
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Administrar la<span class="text-bold">especialización de Doctores</span></h5>
