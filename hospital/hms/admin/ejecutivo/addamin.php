...
<html lang="en">
	<head>
		<title>Ejecutivo | Agregar Administrador</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Ejecutivo | Agregar Administrador</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Ejeutivo</span>
									...
									<li class="active">
										<span>Agregar Administador</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Agregar administrador</h5>
												</div>
...
<div class="form-group">
									<div class="form-group">
									<label for="fess">
															Nombre Admnistrativo
															</label>
					<input type="text" name="username" class="form-control"  placeholder="Cedula" required="true">
														</div>
