...
$query=mysqli_query($con,"select id from  admin where cedula='$cedula' and username='$username'");
					...
					<form class="form-login" method="post">
						<fieldset>
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="text" class="form-control" name="username" placeholder="Nombre del Administrador">
