...
{
$ret=mysqli_query($con,"SELECT * FROM tblpatient WHERE PatientEmail ='".$_POST['username']."' and password='".md5($_POST['password'])."'");
...
<html lang="en">
	<head>
		<title>HW |Inicio de Sesión - Paciente</title>
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../inicioAPP/index.html"><h2>HW |Inicio de Sesión - Paciente</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
								Ingrese su nombre y contraseña para iniciar sesión.<br />
